...
//cy.waitfor()
    ...
    it( 'sign in', () => {
        ...
        cy.get('[data-test="transaction-item-bX35EyEU5"]', {timeout: 1000}).should('be.visible')
        cy.get('[data-test="transaction-item-bX35EyEU5"]').click();
        //Get account balance
        cy.get('[data-test="transaction-amount-bX35EyEU5"]', {timeout: 1000}).should('be.visible')
